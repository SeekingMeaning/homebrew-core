class Hbase < Formula
  ...
  url "https://www.apache.org/dyn/closer.lua?path=hbase/2.2.5/hbase-2.2.5-bin.tar.gz"
  mirror "https://archive.apache.org/dist/hbase/2.2.5/hbase-2.2.5-bin.tar.gz"
